...
public class Pedido implements Serializable{
    ...
    @Schema(description = "Productos del pedido", example = "Ice cream, Smoothie")
    ...
    @Schema(description = "Precio total del pedido", example = "151.99")
    @Min(value = 0, message = "El precio total mínimo es 0.00")
    @Column(name = "precio_total", nullable = false, unique = false) 
    private BigDecimal precio_total;

    @Schema(description = "Telefono del usuario", example = "123456789")
    ...
    @Schema(description = "Direccion del usuario", example = "calle MiCalle")
