...
public class Categoria implements Serializable{
    ...
    @Schema(description = "Descripcion de la categoria", example = "Categoria de Cookies")
    ...
    @Schema(description = "Directorio de la imagen de la categoria", example = "./directorio/cookies.png")
