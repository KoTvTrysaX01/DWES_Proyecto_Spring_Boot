INSERT INTO roles (id, name, description) VALUES (1, 'ADMIN', 'Administrador del sistema con todos los permisos');

ALTER TABLE roles ALTER COLUMN id RESTART WITH (SELECT COALESCE(MAX(id), 0) + 1 FROM roles);



INSERT INTO categorias (id, categoria, descipcion) VALUES (1, 'ice_cream', 'Es un alimento congelado que por lo general se hace de productos lácteos tales como leche o crema.', './ice_creams.png');
INSERT INTO categorias (id, categoria, descipcion) VALUES (2, 'smoothies', 'Es una bebida cremosa no alcohólica preparada a base de trozos y zumos de fruta, concentrados o congelados, mezclados tradicionalmente con productos lácteos, hielo o helado.', './smoothies.png');
INSERT INTO categorias (id, categoria, descipcion) VALUES (3, 'milkshakes', 'El milkshake se basa en helado y leche, mientras que el batido se centra en frutas, verduras y líquidos más ligeros como el yogur o la leche vegetal.', './milkshakes.png');
